...
cardity --version`}
        ...
        <section>
          <h2 className="text-2xl font-semibold text-white mb-6 flex items-center">
            <Play className="w-6 h-6 mr-3 text-cardity-300" />
...
cardity_deploy deploy protocol.carc \\
  ...
  --private-key ...`}
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="card card-gradient">
              ...
              <div className="flex items-center text-sm text-cardity-300">
        ...
        <section>
          <h2 className="text-2xl font-semibold text-white mb-6 flex items-center">
            <ArrowRight className="w-6 h-6 mr-3 text-cardity-300" />
            {t('docs.gettingStarted.nextSteps.title')}
          </h2>
          
          <div className="grid md:grid-cols-3 gap-6">
            <Link href={`/docs/cli?lang=${locale === 'zh' ? 'zh' : 'en'}`} className="card card-gradient hover:bg-dark-800/50 transition-colors">
              <Terminal className="w-8 h-8 text-cardity-300 mb-3" />
            ...
            <Link href={`/examples?lang=${locale === 'zh' ? 'zh' : 'en'}`} className="card card-gradient hover:bg-dark-800/50 transition-colors">
              <Code className="w-8 h-8 text-cardity-300 mb-3" />
            ...
            <Link href={`/docs/deploy?lang=${locale === 'zh' ? 'zh' : 'en'}`} className="card card-gradient hover:bg-dark-800/50 transition-colors">
              <Globe className="w-8 h-8 text-cardity-300 mb-3" />
